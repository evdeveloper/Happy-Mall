...
class ControllerLocalisationCountry extends Controller {
	...
	protected function getList() {
		...
		if (isset($this->request->get['filter_iso_code'])) {
			$filter_iso_code = $this->request->get['filter_iso_code'];
		} else {
			$filter_iso_code = null;
		}
		...
		$filter_data = array(
			...
			'filter_iso_code'  => $filter_iso_code,
		...
		$data['filter_iso_code'] = $filter_iso_code;
	...
	protected function urlFilter() {
		...
		if (isset($this->request->get['filter_iso_code'])) {
			$url .= '&filter_iso_code=' . urlencode(html_entity_decode($this->request->get['filter_iso_code'], ENT_QUOTES, 'UTF-8'));
		}
